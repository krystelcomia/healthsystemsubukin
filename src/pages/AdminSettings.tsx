...
import { Settings, Download, Clock, KeyRound, Mail, CheckCircle2, Eye, EyeOff, ShieldCheck, Lock, Shield, Globe } from "lucide-react";
...
const AdminSettings = () => {
  ...
  return (
    <div className="w-full space-y-6">
      ...
      {/* Single Active Browser Session Policy Card */}
      <SingleSessionPolicyCard />
    </div>
  );
};
