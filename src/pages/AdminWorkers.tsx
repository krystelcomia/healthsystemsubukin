...
import { Users, Plus, Printer, Pencil, Trash2, UserCheck, UserX } from "lucide-react";
  ...
  return (
    <div className="max-w-7xl space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Add, edit, delete, and monitor BHW workers.</p>
      </div>
