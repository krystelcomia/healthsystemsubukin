...
const ResidentRecords = () => {
  ...
  const handlePrint = () => {
    ...
    win.document.write(`<!DOCTYPE html><html><head><title>${selectedResident ? `Record - ${selectedResident.full_name}` : t("residents.title")}</title>
      <style>* { margin: 0; padding: 0; box-sizing: border-box; } body { font-family: 'Segoe UI', Arial, sans-serif; padding: 30px; color: #000000; font-size: 13px; }
        ...
        table { width: 100%; border-collapse: collapse; margin: 12px 0; } th, td { border: 1px solid #000000; padding: 7px 10px; text-align: left; font-size: 12px; color: #000000; } th { background: transparent !important; color: #000000 !important; font-weight: bold !important; }
        h2 { font-size: 15px; color: #000000; margin: 20px 0 8px; border-bottom: 1px solid #000000; padding-bottom: 4px; } .print-date { text-align: right; font-size: 10px; color: #000000; margin-top: 20px; } @media print { body { padding: 15px; } }</style></head><body>`);
    if (!selectedResident) {
      win.document.write(`<div class="header-seal"><img src="${absSanjuan}" alt="San Juan Seal" /><img src="${absHeaderText}" alt="Header Text" /><img src="${absBarangay}" alt="Barangay Subukin Logo" /></div>`);
